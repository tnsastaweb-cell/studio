                         ...
                         <div>
                            <h4 className="font-semibold mb-2">Academic Details</h4>
                             <DynamicTable name="academicDetails" control={form.control} appendValues={{ course: '', institution: '', board: '', year: '', aggregate: '' }} columns={[ {header: 'Course', accessor: 'course'}, {header: 'Institution', accessor: 'institution'}, {header: 'Board/University', accessor: 'board'}, {header: 'Year', accessor: 'year'}, {header: 'Aggregate %', accessor: 'aggregate', type:'number'}, { header: 'Upload Certificate', accessor: 'certificate', type: 'file' } ]} renderRow={(field: any, index: number) => [
                                ['course', 'institution', 'board', 'year', 'aggregate'].map(col => (<TableCell key={col}><FormField control={form.control} name={`academicDetails.${index}.${col}`} render={({ field }) => (<FormItem><FormControl><Input {...field} /></FormControl><FormMessage/></FormItem>)}/></TableCell>)),
                                <TableCell key="certificate"><FormField control={form.control} name={`academicDetails.${index}.certificate`} render={({ field }) => (<FormItem><FormControl><Input type="file" onChange={(e) => field.onChange(e.target.files?.[0])} className="text-xs"/></FormControl><FormMessage/></FormItem>)}/></TableCell>
                            ]} />
                         </div>
                         <Separator/>
                         <div>
                    ...
                    <div className="p-4 border rounded-md space-y-4">
                       ...
                       <Tabs defaultValue="training-taken">
                           ...
                           <TabsContent value="training-taken">
                                <DynamicTable name="trainingsTaken" control={form.control} appendValues={{}} columns={[{header: 'Start Date', accessor: 'startDate', type:'date'}, {header: 'End Date', accessor: 'endDate', type: 'date'}, {header: 'Location', accessor: 'location'}, {header: 'Training Name', accessor: 'name'}]} renderRow={(field: any, index: number) => [
                                    <TableCell key="startDate"><FormField control={form.control} name={`trainingsTaken.${index}.startDate`} render={({ field }) => (<FormItem><Popover><PopoverTrigger asChild><FormControl><Button variant="outline">{field.value ? format(field.value, "PPP") : "Pick date"}</Button></FormControl></PopoverTrigger><PopoverContent><Calendar mode="single" selected={field.value} onSelect={field.onChange}/></PopoverContent></Popover></FormItem>)}/></TableCell>,
                                    <TableCell key="endDate"><FormField control={form.control} name={`trainingsTaken.${index}.endDate`} render={({ field }) => (<FormItem><Popover><PopoverTrigger asChild><FormControl><Button variant="outline">{field.value ? format(field.value, "PPP") : "Pick date"}</Button></FormControl></PopoverTrigger><PopoverContent><Calendar mode="single" selected={field.value} onSelect={field.onChange}/></PopoverContent></Popover></FormItem>)}/></TableCell>,
                                    <TableCell key="location"><FormField control={form.control} name={`trainingsTaken.${index}.location`} render={({ field }) => (<FormItem><FormControl><Input {...field}/></FormControl></FormItem>)}/></TableCell>,
                                    <TableCell key="name"><FormField control={form.control} name={`trainingsTaken.${index}.name`} render={({ field }) => (<FormItem><FormControl><Input {...field}/></FormControl></FormItem>)}/></TableCell>
                                ]} />
                           </TabsContent>
                           <TabsContent value="training-given">
                                <DynamicTable name="trainingsGiven" control={form.control} appendValues={{}} columns={[{header: 'Start Date', accessor: 'startDate', type:'date'}, {header: 'End Date', accessor: 'endDate', type: 'date'}, {header: 'Location', accessor: 'location'}, {header: 'Training Name', accessor: 'name'}]} renderRow={(field: any, index: number) => [
                                    <TableCell key="startDate"><FormField control={form.control} name={`trainingsGiven.${index}.startDate`} render={({ field }) => (<FormItem><Popover><PopoverTrigger asChild><FormControl><Button variant="outline">{field.value ? format(field.value, "PPP") : "Pick date"}</Button></FormControl></PopoverTrigger><PopoverContent><Calendar mode="single" selected={field.value} onSelect={field.onChange}/></PopoverContent></Popover></FormItem>)}/></TableCell>,
                                    <TableCell key="endDate"><FormField control={form.control} name={`trainingsGiven.${index}.endDate`} render={({ field }) => (<FormItem><Popover><PopoverTrigger asChild><FormControl><Button variant="outline">{field.value ? format(field.value, "PPP") : "Pick date"}</Button></FormControl></PopoverTrigger><PopoverContent><Calendar mode="single" selected={field.value} onSelect={field.onChange}/></PopoverContent></Popover></FormItem>)}/></TableCell>,
                                    <TableCell key="location"><FormField control={form.control} name={`trainingsGiven.${index}.location`} render={({ field }) => (<FormItem><FormControl><Input {...field}/></FormControl></FormItem>)}/></TableCell>,
                                    <TableCell key="name"><FormField control={form.control} name={`trainingsGiven.${index}.name`} render={({ field }) => (<FormItem><FormControl><Input {...field}/></FormControl></FormItem>)}/></TableCell>
                                ]} />
                           </TabsContent>
                           <TabsContent value="pilot-audits">
                                <DynamicTable name="pilotAudits" control={form.control} appendValues={{}} columns={[{header: 'Start Date', accessor: 'startDate', type:'date'}, {header: 'End Date', accessor: 'endDate', type: 'date'}, {header: 'Location', accessor: 'location'}, {header: 'Scheme Name', accessor: 'scheme'}]} renderRow={(field: any, index: number) => [
                                    <TableCell key="startDate"><FormField control={form.control} name={`pilotAudits.${index}.startDate`} render={({ field }) => (<FormItem><Popover><PopoverTrigger asChild><FormControl><Button variant="outline">{field.value ? format(field.value, "PPP") : "Pick date"}</Button></FormControl></PopoverTrigger><PopoverContent><Calendar mode="single" selected={field.value} onSelect={field.onChange}/></PopoverContent></Popover></FormItem>)}/></TableCell>,
                                    <TableCell key="endDate"><FormField control={form.control} name={`pilotAudits.${index}.endDate`} render={({ field }) => (<FormItem><Popover><PopoverTrigger asChild><FormControl><Button variant="outline">{field.value ? format(field.value, "PPP") : "Pick date"}</Button></FormControl></PopoverTrigger><PopoverContent><Calendar mode="single" selected={field.value} onSelect={field.onChange}/></PopoverContent></Popover></FormItem>)}/></TableCell>,
                                    <TableCell key="location"><FormField control={form.control} name={`pilotAudits.${index}.location`} render={({ field }) => (<FormItem><FormControl><Input {...field}/></FormControl></FormItem>)}/></TableCell>,
                                    <TableCell key="scheme"><FormField control={form.control} name={`pilotAudits.${index}.scheme`} render={({ field }) => (<FormItem><FormControl><Input {...field}/></FormControl></FormItem>)}/></TableCell>
                                ]} />
                           </TabsContent>
                           <TabsContent value="state-office">
                               <DynamicTable name="stateOfficeActivities" control={form.control} appendValues={{}} columns={[{header: 'Year', accessor: 'year'}, {header: 'Work Particulars', accessor: 'particulars'}]} renderRow={(field: any, index: number) => [
                                <TableCell key="year"><FormField control={form.control} name={`stateOfficeActivities.${index}.year`} render={({ field }) => (<FormItem><FormControl><Input {...field}/></FormControl></FormItem>)}/></TableCell>,
                                <TableCell key="particulars"><FormField control={form.control} name={`stateOfficeActivities.${index}.particulars`} render={({ field }) => (<FormItem><FormControl><Input {...field}/></FormControl></FormItem>)}/></TableCell>
                               ]} />
                           </TabsContent>
                       </Tabs>
                    </div>
