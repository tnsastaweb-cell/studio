...
export default function MgnregsFdReportPage() {
    ...
    const reportData = useMemo(() => {
        ...
        const fdEntries = yearFilteredEntries.map(entry => ({
            ...entry,
            paraParticulars: entry.paraParticulars?.filter(p => p.type === 'FD - Financial Deviation')
        ...
        const processEntries = (geoList: string[], groupBy: 'district' | 'block' | 'panchayat') => {
            ...
            aggregation.forEach((value) => {
                const auditedInGroup = fdEntries.filter(e => {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1 container mx-auto px-4 py-8 pb-24 space-y-8">
                <Card>
                    <CardHeader>
                        <CardTitle>R.6.1.B.2 FD - Financial Deviation</CardTitle>
                        <CardDescription>A summary of Financial Deviation issues for MGNREGS.</CardDescription>
                    </CardHeader>
