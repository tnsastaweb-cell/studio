...
export default function PmaygIndividualIssuesListingPage() {
    ...
    const handleGetReport = () => {
        const result = flattenedPmayg.filter(item => {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1 container mx-auto px-4 py-8 pb-24 space-y-8">
                <Card>
                    <CardHeader>
                        <CardTitle>R.6.2.A.2 INDIVIDUAL ISSUES LISTING (PMAY-G)</CardTitle>
                        <CardDescription>Filter and view individual issues reported for PMAY-G.</CardDescription>
                    </CardHeader>
                    <CardContent>
