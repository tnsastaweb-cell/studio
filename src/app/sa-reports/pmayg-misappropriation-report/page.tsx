...
export default function PmaygMisappropriationReportPage() {
    ...
    const reportData = useMemo(() => {
        ...
        const misappropriationEntries = yearFilteredEntries.map(entry => ({
            ...entry,
            paraParticulars: entry.paraParticulars?.filter(p => p.type === 'முறைகேடு')
        ...
        const processEntries = (geoList: string[], groupBy: 'district' | 'block' | 'panchayat') => {
            ...
            aggregation.forEach((value) => {
                const auditedInGroup = misappropriationEntries.filter(e => {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1 container mx-auto px-4 py-8 pb-24 space-y-8">
                <Card>
                    <CardHeader>
                        <CardTitle>R.6.2.B.1 முறைகேடு</CardTitle>
                        <CardDescription>A summary of misappropriation issues for PMAY-G for the expenditure year {EXPENDITURE_YEAR}.</CardDescription>
                    </CardHeader>
