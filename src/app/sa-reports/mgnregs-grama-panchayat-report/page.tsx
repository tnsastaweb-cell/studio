...
export default function MgnregsGramaPanchayatSocialAuditReport() {
    ...
    const sgsDatesForPanchayat = useMemo(() => {
        ...
        return mgnregsEntries.filter((e) => e.panchayat === filters.panchayat).map((e) => e.sgsDate);
    }, [filters.panchayat, mgnregsEntries]);

    const handleGetReport = () => {
        const entry = mgnregsEntries.find((e) => 
    ...
    const handlePrint = useReactToPrint({
        ...
        documentTitle: `MGNREGS_Social_Audit_Report_${selectedReport?.district}`
    });
                ...
                <Card>
                    <CardHeader>
                        <div className="flex justify-between items-center">
                            <div>
                               <CardTitle>R.6.1.A.1 GRAMA PANCHAYAT SOCIAL AUDIT REPORT (MGNREGS)</CardTitle>
