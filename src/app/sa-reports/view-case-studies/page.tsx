    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                ...
                <div><strong>BRP Name:</strong> {caseStudy.brpName}</div>
            ...
            {caseStudy.tableData && caseStudy.tableData.length > 0 && (
                 <Card>
                    <CardHeader><CardTitle>Generated Table</CardTitle></CardHeader>
                    <CardContent>
...
export default function ViewCaseStudiesPage() {
    ...
    const handleEdit = () => {
        if (currentCaseStudy) {
            router.push(`/sa-reports/case-studies?edit=${currentCaseStudy.caseStudyNo}`);
        }
    };
