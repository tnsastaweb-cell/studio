...
export default function MgnregsPvReportPage() {
    ...
    const reportData = useMemo(() => {
        ...
        const pvEntries = yearFilteredEntries.map(entry => ({
            ...entry,
            paraParticulars: entry.paraParticulars?.filter(p => p.type === 'PV - Process Violation')
        ...
        const processEntries = (geoList: string[], groupBy: 'district' | 'block' | 'panchayat') => {
            ...
            aggregation.forEach((value) => {
                const auditedInGroup = pvEntries.filter(e => {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1 container mx-auto px-4 py-8 pb-24 space-y-8">
                <Card>
                    <CardHeader>
                        <CardTitle>R.6.1.B.3 PV - Process Violation</CardTitle>
                        <CardDescription>A summary of Process Violation issues for MGNREGS.</CardDescription>
                    </CardHeader>
