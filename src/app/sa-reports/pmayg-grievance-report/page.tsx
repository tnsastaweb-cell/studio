...
export default function PmaygGrievanceReportPage() {
    ...
    const reportData = useMemo(() => {
        ...
        const grievanceEntries = yearFilteredEntries.map(entry => ({
            ...entry,
            paraParticulars: entry.paraParticulars?.filter(p => p.type === 'குறை')
        ...
        const processEntries = (geoList: string[], groupBy: 'district' | 'block' | 'panchayat') => {
            ...
            grievanceEntries.forEach(entry => {
            ...
            aggregation.forEach((value) => {
                const auditedInGroup = grievanceEntries.filter(e => {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1 container mx-auto px-4 py-8 pb-24 space-y-8">
                <Card>
                    <CardHeader>
                        <CardTitle>R.6.2.B.3 குறை</CardTitle>
                        <CardDescription>A summary of grievance issues for PMAY-G for the expenditure year {EXPENDITURE_YEAR}.</CardDescription>
                    </CardHeader>
