...
const ChartBox = ({ label, className, level }: { label: string; className?: string, level: number }) => (
  <div className={cn(
      "bg-green-700 text-white rounded-lg p-3 text-center font-bold shadow-md mx-auto w-60",
...
const ArrowDown = ({ className = '' }: { className?: string }) => (
  <div className={cn("w-0 h-0 border-l-8 border-r-8 border-t-8 border-l-transparent border-r-transparent border-t-green-700 mx-auto", className)}></div>
);
  ...
  return (
    <div className="p-4 md:p-8 bg-background rounded-lg overflow-x-auto">
        <div className="flex flex-col items-center space-y-4 min-w-[1200px]">
            ...
            <Connector vertical />
            <div className="w-1/2 h-1 bg-green-700 mx-auto"></div>

            {/* Connectors to Level 2 */}
            <div className="flex justify-center w-full relative">
                <div className="absolute top-0 left-0 h-full w-1/2 border-r border-green-700"></div>
                <div className="absolute top-0 right-0 h-full w-1/2"></div>
                <div className="absolute top-0 left-1/4 w-px h-8 bg-green-700"></div>
                <div className="absolute top-0 right-1/4 w-px h-8 bg-green-700"></div>
            ...
            <div className="flex justify-center w-full relative h-8">
                 <div className="absolute top-0 left-1/4 w-px h-full bg-green-700"></div>
                 <div className="absolute top-0 right-1/4 w-px h-full bg-green-700"></div>
                 <div className="absolute bottom-0 left-1/4 w-1/2 h-px bg-green-700"></div>
            </div>
             <Connector vertical />
             <ArrowDown />
            ...
            <div className="w-full h-1 bg-green-700"></div>
             <div className="flex justify-between w-full relative">
                 <div className="absolute top-0 left-[12.5%] w-px h-8 bg-green-700"><ArrowDown className="relative -left-2 top-8" /></div>
                 <div className="absolute top-0 left-[37.5%] w-px h-8 bg-green-700"><ArrowDown className="relative -left-2 top-8" /></div>
                 <div className="absolute top-0 right-[37.5%] w-px h-8 bg-green-700"><ArrowDown className="relative -left-2 top-8" /></div>
                 <div className="absolute top-0 right-[12.5%] w-px h-8 bg-green-700"><ArrowDown className="relative -left-2 top-8" /></div>
            </div>
             ...
             <div className="flex justify-between w-full pt-8">
                ...
                <div className="w-1/4 flex flex-col items-center space-y-4">
                    ...
                    <div className="flex w-full justify-around relative">
                        <div className="absolute top-0 left-1/4 w-px h-4 bg-green-700"><ArrowDown className="relative -left-2 top-4" /></div>
                        <div className="absolute top-0 right-1/4 w-px h-4 bg-green-700"><ArrowDown className="relative -left-2 top-4" /></div>
                    </div>
