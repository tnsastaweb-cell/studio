...
export const MOCK_USERS: User[] = [
  ...
  { id: 498, name: 'S. Manimaran', employeeCode: 'TN-1087-IC', designation: 'DRP I/C', mobileNumber: '9626205694', dateOfBirth: '1986-01-18', password: 'password123', status: 'active' },
  { id: 499, name: 'G.Kalilur Rehman', employeeCode: 'TN-957-IC', designation: 'DRP I/C', mobileNumber: '8072267181', dateOfBirth: '1986-07-11', password: 'password123', status: 'active' },
  { id: 500, name: 'K.Ramanajothi', employeeCode: 'TN-752', designation: 'DRP', mobileNumber: '9585973351', dateOfBirth: '1975-06-03', password: 'password123', status: 'active' },
  { id: 501, name: 'P.Prema', employeeCode: 'TN-1268-IC', designation: 'DRP I/C', mobileNumber: '8667232805', dateOfBirth: '1968-07-16', password: 'password123', status: 'active' },
  { id: 502, name: 'G.Ashok Kumar', employeeCode: 'TN-881', designation: 'DRP', mobileNumber: '9489042846', dateOfBirth: '1984-10-24', password: 'password123', status: 'active' },
  ...
  { id: 510, name: 'G.Vinoth', employeeCode: 'TN-1008-IC', designation: 'DRP I/C', mobileNumber: '7904706149', dateOfBirth: '1985-06-10', password: 'password123', status: 'active' },
  { id: 511, name: 'P.Vajjiravel', employeeCode: 'TN-1105-IC', designation: 'DRP I/C', mobileNumber: '8148868321', dateOfBirth: '1977-09-06', password: 'password123', status: 'active' },
  { id: 512, name: 'K.Abdul Kadhar Jailani', employeeCode: 'TN-706', designation: 'DRP', mobileNumber: '9342666803', dateOfBirth: '1982-05-31', password: 'password123', status: 'active' },
  { id: 513, name: 'K.Sundararajan', employeeCode: 'TN-997', designation: 'DRP', mobileNumber: '8015801694', dateOfBirth: '1981-07-15', password: 'password123', status: 'active' },
  { id: 514, name: 'S.Maharajan', employeeCode: 'TN-732-IC', designation: 'DRP I/C', mobileNumber: '8220826461', dateOfBirth: '1989-11-23', password: 'password123', status: 'active' },
  { id: 515, name: 'M.Ghouskhan', employeeCode: 'TN-982-IC', designation: 'DRP I/C', mobileNumber: '9047705380', dateOfBirth: '1990-10-22', password: 'password123', status: 'active' },
  { id: 516, name: 'T.Muthukumaran', employeeCode: 'TN-21', designation: 'DRP', mobileNumber: '9944817100', dateOfBirth: '1978-09-11', password: 'password123', status: 'active' },
  { id: 517, name: 'S.Vijayalakshmi', employeeCode: 'TN-1349', designation: 'DRP', mobileNumber: '9944111187', dateOfBirth: '1978-05-16', password: 'password123', status: 'active' },
  { id: 518, name: 'J.Sathya', employeeCode: 'TN-763', designation: 'DRP', mobileNumber: '8012109906', dateOfBirth: '1985-07-15', password: 'password123', status: 'active' },
  { id: 519, name: 'K.Sivasubramanian', employeeCode: 'TN-1016', designation: 'DRP', mobileNumber: '9655859638', dateOfBirth: '1979-08-18', password: 'password123', status: 'active' },
  { id: 520, name: 'P.Prabhakar', employeeCode: 'TN-839-IC', designation: 'DRP I/C', mobileNumber: '9952688998', dateOfBirth: '1977-06-12', password: 'password123', status: 'active' },
  { id: 521, name: 'M.Alagumurugan', employeeCode: 'TN-667', designation: 'DRP', mobileNumber: '6385132063', dateOfBirth: '1972-02-17', password: 'password123', status: 'active' },
  { id: 522, name: 'T.Saravanan', employeeCode: 'TN-1345-IC', designation: 'DRP I/C', mobileNumber: '9842519503', dateOfBirth: '1984-01-26', password: 'password123', status: 'active' },
  { id: 523, name: 'S.Pandiyan', employeeCode: 'TN-1017-IC', designation: 'DRP I/C', mobileNumber: '9790590043', dateOfBirth: '1971-06-30', password: 'password123', status: 'active' },
  { id: 524, name: 'S.Sivakumar', employeeCode: 'TN-896-IC', designation: 'DRP I/C', mobileNumber: '8807115346', dateOfBirth: '1973-05-20', password: 'password123', status: 'active' },
  { id: 525, name: 'K.Velthai', employeeCode: 'TN-14', designation: 'DRP', mobileNumber: '9791776165', dateOfBirth: '1973-05-22', password: 'password123', status: 'active' },
  { id: 526, name: 'C.Manimaran', employeeCode: 'TN-1163', designation: 'DRP', mobileNumber: '9941557767', dateOfBirth: '1976-03-25', password: 'password123', status: 'active' },
  { id: 527, name: 'S.James Billa Mary', employeeCode: 'TN-731-IC', designation: 'DRP I/C', mobileNumber: '8608007171', dateOfBirth: '1976-05-17', password: 'password123', status: 'active' },
  { id: 528, name: 'T.Sekar', employeeCode: 'TN-975', designation: 'DRP', mobileNumber: '9943398201', dateOfBirth: '1982-02-17', password: 'password123', status: 'active' },
  { id: 529, name: 'M.Chinnsamy', employeeCode: 'TN-1095', designation: 'DRP', mobileNumber: '9790291322', dateOfBirth: '1976-04-10', password: 'password123', status: 'active' },
  { id: 530, name: 'A.Pushpalatha', employeeCode: 'TN-1013', designation: 'DRP', mobileNumber: '8610494781', dateOfBirth: '1983-06-01', password: 'password123', status: 'active' },
  { id: 531, name: 'S.Mani', employeeCode: 'TN-1350', designation: 'DRP', mobileNumber: '9976880100', dateOfBirth: '1973-12-17', password: 'password123', status: 'active' },
  { id: 532, name: 'V.Sekar', employeeCode: 'TN-867', designation: 'DRP', mobileNumber: '9994836638', dateOfBirth: '1978-03-11', password: 'password123', status: 'active' },
  { id: 533, name: 'E.Mohan', employeeCode: 'TN-22', designation: 'DRP', mobileNumber: '9894915623', dateOfBirth: '1984-06-02', password: 'password123', status: 'active' },
  { id: 534, name: 'M.Kanson', employeeCode: 'TN-683-IC', designation: 'DRP I/C', mobileNumber: '9994574681', dateOfBirth: '1975-09-16', password: 'password123', status: 'active' },
  { id: 535, name: 'K.Yogamangalam', employeeCode: 'TN-1378', designation: 'ADMIN', mobileNumber: '8056943916', dateOfBirth: '1983-01-12', password: 'password123', status: 'active' },
  { id: 536, name: 'KARUNA', employeeCode: 'TN-CON', designation: 'CONSULTANT', mobileNumber: '9444839240', dateOfBirth: '1976-01-01', password: 'password123', status: 'active' }
];
